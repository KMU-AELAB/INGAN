...
class Up(nn.Module):
    def __init__(self, _in, _out):
        ...
        self.deconv = nn.ConvTranspose2d(in_channels=_in, out_channels=_out * 2, kernel_size=4, stride=2,
...
class Hourglass(nn.Module):
    ...
    def forward(self, x):
        ...
        up5 = self.relu(self.up5(x, down5))
        up4 = self.relu(self.up5(up5, down4))
        up3 = self.relu(self.up5(up4, down3))
        up2 = self.relu(self.up5(up3, down2))
        up1 = self.up5(up2, down1)
